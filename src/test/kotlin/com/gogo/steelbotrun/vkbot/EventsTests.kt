...
class EventsTests : StringSpec({
	...
	companion object {
		fun userMessage(text: String) = "{\"type\":\"message_new\",\"object\":{\"message\":{\"date\":1627363371,\"from_id\":1,\"id\":1,\"out\":0,\"peer_id\":1,\"text\":\"$text\",\"conversation_message_id\":1,\"fwd_messages\":[],\"important\":false,\"random_id\":0,\"attachments\":[],\"is_hidden\":false},\"client_info\":{\"button_actions\":[\"text\",\"vkpay\",\"open_app\",\"location\",\"open_link\",\"callback\",\"intent_subscribe\",\"intent_unsubscribe\"],\"keyboard\":true,\"inline_keyboard\":true,\"carousel\":true,\"lang_id\":3}},\"group_id\":1,\"event_id\":\"1\"}"
	}
}
