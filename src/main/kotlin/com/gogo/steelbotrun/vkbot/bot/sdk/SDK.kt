...
import com.gogo.steelbotrun.vkbot.utils.json.JSONGoogle
import com.gogo.steelbotrun.vkbot.utils.json.JSONJackson
import com.gogo.steelbotrun.vkbot.bot.sdk.Attachment.*
import com.gogo.steelbotrun.vkbot.bot.sdk.HttpClient.Companion.sendMultiPartFormRequest
import com.gogo.steelbotrun.vkbot.bot.sdk.HttpClient.Companion.sendRequest
import java.io.*
import java.util.*
import kotlin.collections.HashMap

const val vkapi = "https://api.vk.com/method/"
val file_token = File("${System.getProperty("user.dir")}/BotInfo.txt").readLines().first()
const val apiVersion = "5.131"

class SDK(private val token: String = file_token) {
